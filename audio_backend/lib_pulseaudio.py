...
PA_CHANNELS_MAX = c_uint(32) # Variable c_uint '32u'
PA_PROP_WINDOW_DESKTOP = 'window.desktop' # Variable STRING '(const char*)"window.desktop"'
PA_NSEC_PER_SEC = c_ulonglong(1000000000) # Variable c_ulonglong '1000000000ull'
PA_PROP_WINDOW_ICON = 'window.icon' # Variable STRING '(const char*)"window.icon"'
PA_NSEC_PER_MSEC = c_ulonglong(1000000) # Variable c_ulonglong '1000000ull'
PA_USEC_PER_MSEC = c_ulong(1000) # Variable c_ulong '1000u'
...
PA_VOLUME_MUTED = c_uint(0) # Variable c_uint '0u'
...
PA_USEC_PER_SEC = c_ulong(1000000) # Variable c_ulong '1000000u'
...
PA_RATE_MAX = c_uint(192000) # Variable c_uint '192000u'
...
PA_INVALID_INDEX = c_uint(4294967295) # Variable c_uint '4294967295u'
...
PA_USEC_INVALID = c_ulong(18446744073709551615) # Variable c_ulong '-1u'
...
PA_USEC_MAX = c_ulong(18446744073709551614) # Variable c_ulong '-2u'
...
PA_MSEC_PER_SEC = c_ulong(1000) # Variable c_ulong '1000u'
